...
class TaskViewModel: Identifiable, ObservableObject {
    ...
    @Published var tasks: [Task] = [
        ...
        Task(name: "Buy Some Foods", taskName: "BBinstant", date: Date(timeIntervalSinceReferenceDate: 1619231231.0), priority: .high),
        Task(name: "Lanch The App", taskName: "App Store", date: Date(), priority: .medium),
